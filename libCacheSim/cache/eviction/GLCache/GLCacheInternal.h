...
typedef struct learner {
  ...
  /*  For LightGBM  */
  DatasetHandle train_dm_lightgbm;
  DatasetHandle valid_dm_lightgbm;
  DatasetHandle inf_dm_lightgbm;
...
typedef struct {
  ...
  int32_t index_seg_with_obj_type_0;
  int32_t index_seg_with_obj_type_1;

  segment_t *seg_with_obj_type_0;
  segment_t *seg_with_obj_type_1;
